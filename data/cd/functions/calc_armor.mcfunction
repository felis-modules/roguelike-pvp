...
scoreboard players operation @s cd_armor_e *= 40 const
scoreboard players operation @s cd_armor_e *= @s cd_dmg
execute store result score @s cd_tough run attribute @s minecraft:generic.armor_toughness get
scoreboard players operation @s cd_var = 160 const
scoreboard players operation @s cd_var *= @s cd_dmg
scoreboard players operation @s cd_var *= @s cd_dmg
scoreboard players operation @s cd_tough += 8 const
