scoreboard players set .slot invparse 103 
...
execute in overworld run loot replace entity @s armor.head 1 mine -30000000 -64 1602 minecraft:air{drop_contents:1b} 
