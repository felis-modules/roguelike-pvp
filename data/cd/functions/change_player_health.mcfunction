...
execute if score @s cd_hp_e matches ..0 run tellraw @a [{"text":"[클래스 PVP] "},{"selector":"@s"},{"text":" ⟾ "},{"nbt":"SelectedItem.tag.display.Name","entity":"@s","interpret":true,"bold":false,"italic":false},{"text":" ⟾ "},{"selector":"@a[scores={cd_attacker=1..}]"}]
