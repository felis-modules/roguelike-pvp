...
execute as @s[type=player] store result score @s cd_tough run attribute @s minecraft:generic.armor_toughness get 10
execute as @s[type=!player] store result score @s cd_tough run data get entity @s Attributes[{Name:"minecraft:generic.armor_toughness"}].Base 10
