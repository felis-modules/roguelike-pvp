scoreboard players remove @a[scores={RP_COOL1=1..}] RP_COOL1 1
scoreboard players remove @a[scores={RP_COOL2=1..}] RP_COOL2 1
scoreboard players remove @a[scores={RP_COOL3=1..}] RP_COOL3 1
...
execute as @a[tag=mercenary] run function roguelike:character/mercenary/global_schedule
