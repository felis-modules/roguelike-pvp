...
item replace entity @s hotbar.1 with ender_pearl{invparse:300001,display:{Name:'{"text":"암살자의 엔더 진주","color":"aqua","bold":false,"italic":false}',Lore:['{"text":"자동 충전형 엔더 진주이다.","color":"gray","bold":false,"italic":false}']}}

function roguelike:character/assassin/pearl/update_counts
