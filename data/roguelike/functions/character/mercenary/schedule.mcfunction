...
tellraw @s[scores={RP_COOL2=1}] {"text":"[클래스 PVP] 방패돌진 사용 가능","color":"gray","bold":false,"italic":false}
tellraw @s[scores={RP_COOL3=1}] {"text":"[클래스 PVP] 참기 사용 가능","color":"gray","bold":false,"italic":false}
