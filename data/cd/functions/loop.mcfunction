execute as @e[type=player,scores={cd_dmg=-60..60}] run function cd:change_player_health
execute as @e[type=player,scores={cd_dmg2=1..60}] run function cd:change_player_health
execute as @e[type=!player,scores={cd_dmg=-60..60}] run function cd:change_mob_health
